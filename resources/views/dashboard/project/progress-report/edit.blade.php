          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <textarea name="results" id="edit_results" class="form-control" rows="10"></textarea>
                </div>
                <div class="form-group">
                    <label for="technical_accomplishments">Technical Accomplishments</label>
                    <textarea name="technical_accomplishments" id="edit_technical_accomplishments" class="form-control" rows="10"></textarea>
                </div>
